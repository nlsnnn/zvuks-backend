...
from app.users.schemas import SUserAuth, SUserRegister, SUserProfile
...
async def get_user_profile(user_id: int, user_data: User = Depends(token_depends.get_current_user)):
